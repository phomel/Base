package com.joy.phomel.common.utils;

import android.content.Context;

import com.joy.phomel.common.application.BaseApplication;
...
public class AppDataManager {
    ...
    private static void cleanExternalCache(Context context) {
        if (SDCardManager.isExistSD()) {
            FileUtils.deleteFolderFile(BaseApplication.IMAGE_DIR, false);
            FileUtils.deleteFolderFile(BaseApplication.IMAGE_UPLOAD_TEMP, false);
            FileUtils.deleteFolderFile(BaseApplication.FILE_DIR, false);
            FileUtils.deleteFolderFile(BaseApplication.LOG_DIR, false);
        }
    }
