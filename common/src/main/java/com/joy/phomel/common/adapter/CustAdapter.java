package com.joy.phomel.common.adapter;
 ...
 */
public abstract class CustAdapter<E> extends BaseAdapter {
    ...
    public CustAdapter(Context context, List<E> list, int itemLayoutRes) {
